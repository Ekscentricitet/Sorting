...
public class Mergesort implements SortingAlgorithm
{
    ...
    private void sort (Comparable[] arrayToSort, Comparable[] auxiliary, int lowLeft, int highRight)
    {
    ...
    private void merge (Comparable[] arrayToSort, Comparable[] auxiliary, int lowLeft, int middle, int highRight)
    {
